        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li id="sapi" class="nav-item">
                    ...
                    <div id="datasapi" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Data Sapi :</h6>
                            <a class="collapse-item" href="{{url('/sapi')}}">Daftar Sapi</a>
                            <a class="collapse-item" href="{{url('/sapi-masuk')}}">Sapi Masuk</a>
                            <a class="collapse-item" href="{{url('/sapi-keluar')}}">Sapi Keluar</a>
                        </div>
                    </div>
                </li>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Apakah anda benar benar akan keluar ?</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body">Tekan tombol "Logout" dibawah untuk keluar dari sistem.</div>
